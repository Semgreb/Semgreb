...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        ...
        if (
            ...
            ?>
            <p class="project-info tw-mb-0 tw-font-small tw-text-base tw-tracking-tight" style="font-size:.7.1rem;">
            ...
            <p class="project-info tw-mb-0 tw-font-small tw-text-base" style="font-size:.8rem; margin-top:-20px;">
                <?php if (
