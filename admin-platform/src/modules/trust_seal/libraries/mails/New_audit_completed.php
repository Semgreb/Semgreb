...
class New_audit_completed extends App_mail_template
{
    ...
    public $slug = 'trust_seal-audit-to-client';
    ...
    public function build()
    {
        ...
        $this->to($this->client_email)
            ...
            ->set_merge_fields('trust_seal_merge_fields', $this->slug, $this->auditid, '', $this->contactid);
    }
}
