...
|
*/
$user_key = get_option("seal_api_user");
$password_key = get_option("seal_api_password");

$config['rest_valid_logins'] = [$user_key => $password_key];
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_ip_whitelist'] = 'sello-confianza-website-test.azurewebsites.net';
