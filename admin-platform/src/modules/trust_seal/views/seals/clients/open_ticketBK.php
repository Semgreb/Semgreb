        ...
        <div class="panel_s">
            <div class="panel-body">
                            ...
                            <div class="form-group open-ticket-service-group">
                                ...
                                <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" name="service" id="service" class="form-control selectpicker">
                                    ...
                                    <?php foreach ($services as $service) { ?>
                                        <option value="<?php echo $service['serviceid']; ?>" <?php echo set_select('service', $service['serviceid'], (count($services) == 1 ? true : false)); ?>>
                ...
                <div class="form-group open-ticket-message-group">
                    ...
                    <textarea name="message" id="message" class="form-control" placeholder="<?php echo _l('clients_ticket_open_body'); ?>" rows="8"><?php echo strip_tags($seal->description); ?></textarea>
                </div>
