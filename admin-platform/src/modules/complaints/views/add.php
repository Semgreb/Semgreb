...
<div id="wrapper">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group select-placeholder" id="ticket_contact_w">
                                    <label for="contactid"><?php echo _l('consumer'); ?></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="assigned" id="assigned" class="form-control selectpicker" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-width="100%">
                                        <option value=""><?php echo _l('complaint_settings_none_assigned'); ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-<?php if (get_option('services') == 1) {
                                        ...
                                        echo render_select('priority', $priorities, ['priorityid', 'name'], 'ticket_settings_priority', hooks()->apply_filters('new_complaint_priority_selected', 2), ['required' => 'true']); ?>
                                    </div>
                                    <?php if (get_option('services') == 1) { ?>
                                        <div class="col-md-6">
                                            <?php if (is_admin() || get_option('staff_members_create_inline_ticket_services') == '1') {
                                                echo render_select_with_input_group('service', $services, ['serviceid', 'name'], 'ticket_settings_service', '', '<div class="input-group-btn"><a href="#" class="btn btn-default" onclick="new_service_complaint();return false;"><i class="fa fa-plus"></i></a></div>');
                                            } else {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group select-placeholder">
                                            <label for="userid" class="control-label"><?php echo _l('client'); ?></label>
                            ...
                            <div class="col-md-12 tw-mt-3">
                                <h4 class="tw-mt-0 tw-font-semibold tw-text-base tw-text-neutral-700">
                                    <?php echo _l('complaint_add_body'); ?>
                                </h4>
                                <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <button class="btn btn-default add_more_attachments" data-max="<?php echo get_option('maximum_allowed_ticket_attachments'); ?>" type="button"><i class="fa fa-plus"></i></button>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="btn-bottom-toolbar text-right">
                            ...
                            <button type="submit" data-form="#new_ticket_form" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" class="btn btn-primary"><?php echo _l('save'); ?></button>
    ...
    <script>
        function init_seal() {
            window.location.href = '<?php echo admin_url('complaints'); ?>';
        }

        function new_service_complaint() {
        ...
        $(function() {
            ...
            $("#new_complaint_form").appFormValidator({
                rules: {
                    subject: "required",
                    contactid: "required",
                    userid: "required"
