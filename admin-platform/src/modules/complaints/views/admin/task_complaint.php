...
<?php echo form_open_multipart(admin_url('complaints/task_complaint' . ($id ? '/' . $id : '')), ['id' => 'task-form']); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            if ($this->input->get('complaint_to_task')) {
                                echo form_hidden('complaint_to_task', $rel_id);
                            }
                        } ?>
                        <hr class="-tw-mx-3.5" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="rel_type" class="selectpicker" id="rel_type" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        ...
                                        <option value="complaint" <?php if (isset($task) || $this->input->get('rel_type')) {
                                                                        if ($rel_type == 'complaint') {
                                                                            echo 'selected';
                                                                        }
                                                                    } ?>>
                                    ...
                                    <div id="rel_id_select">
                                        <select name="rel_id" id="rel_id" class="ajax-sesarch" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                            <?php if ($rel_id != '' && $rel_type != '') {
                                                $rel_data = get_relation_data_complaint_module($rel_type, $rel_id);
                                                $rel_val  = get_relation_values_complaint_module($rel_data, $rel_type);
