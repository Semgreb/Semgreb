...
class Emails extends AdminController
{
    ...
    public function index()
    {
        ...
        $data['complaints'] = $this->emails_model->get([
            'type'     => 'complaint',
            'language' => 'english',
        ]);
        ...
        $this->load->view('complaints/emails/email_templates', $data);
    }
    ...
    public function email_template($id)
    {
        ...
        if (!$id) {
            redirect(admin_url('complaints/emails'));
        }
        ...
        if ($this->input->post()) {
            ...
            redirect(admin_url('complaints/emails/email_template/' . $id));
        }
        ...
        $data['title']    = $title;
        $this->load->view('complaints/emails/template', $data);
    }
